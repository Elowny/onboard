#ifndef ONBOARD_PREDICTION_NET_HORIZON_PREDICTION_J5_QNN_H
#define ONBOARD_PREDICTION_NET_HORIZON_PREDICTION_J5_QNN_H
...
class PredictionJ5QNN {
 public:
  explicit PredictionJ5QNN(const NetParam& net_param);
  virtual ~PredictionJ5QNN();
...
#endif  // ONBOARD_PREDICTION_NET_HORIZON_PREDICTION_J5_QNN_H
