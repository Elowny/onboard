...
const std::vector<typename MsdStaticBoundaryCostV2<Mfob>::Layer> kLayers = {
    typename MsdStaticBoundaryCostV2<Mfob>::Layer{
        .gain_of_weight = 1.0,
        .buffer_at_speed = PiecewiseLinearFunction<double>{
            std::vector<double>{0.0, 2.0}, std::vector<double>{0.8, 1.2}}}};

const std::vector<std::string> kSubNames = {""};
const char kName[] = "MsdStaticBoundaryCostV2Test";
...
class MsdStaticBoundaryCostV2Test : public ::testing::Test {
 public:
  void SetUp() override {
    ...
    // This is a hack to pass unit-test because width of Q0001 has beed modified
    // to 1.87m after the unit-test was implemented.
    vehicle_geometry_params_.set_width(2.11);
...
TEST_F(MsdStaticBoundaryCostV2Test, MfobSumGTest) {
  MsdStaticBoundaryCostV2<Mfob> cost(
      kSteps, *curb_msd_, center_line_query_helper_.get(), kSubNames, kLayers,
      circle_center_offsets_, radiuses_,
      /*using_hessian_approximate=*/false, kName);
  MfobCostEvaluationTest::SumForAllStepsTest(&cost);
}

TEST_F(MsdStaticBoundaryCostV2Test, MfobEvaluateWithDebugInfoGTest) {
  MsdStaticBoundaryCostV2<Mfob> cost(
      kSteps, *curb_msd_, center_line_query_helper_.get(), kSubNames, kLayers,
      circle_center_offsets_, radiuses_,
      /*using_hessian_approximate=*/false, kName);
...
TEST_F(MsdStaticBoundaryCostV2Test, MfobUpdateTest) {
  MsdStaticBoundaryCostV2<Mfob> cost(
      kSteps, *curb_msd_, center_line_query_helper_.get(), kSubNames, kLayers,
      circle_center_offsets_, radiuses_,
      /*using_hessian_approximate=*/false, kName);
...
TEST_F(MsdStaticBoundaryCostV2Test, MfobDGDxTest) {
  MsdStaticBoundaryCostV2<Mfob> cost(
      kSteps, *curb_msd_, center_line_query_helper_.get(), kSubNames, kLayers,
      circle_center_offsets_, radiuses_,
      /*using_hessian_approximate=*/false, kName);
...
TEST_F(MsdStaticBoundaryCostV2Test, MfobDDGDxDxTest) {
  MsdStaticBoundaryCostV2<Mfob> cost(
      kSteps, *curb_msd_, center_line_query_helper_.get(), kSubNames, kLayers,
      circle_center_offsets_, radiuses_,
      /*using_hessian_approximate=*/false, kName);
...
TEST_F(MsdStaticBoundaryCostV2Test, MfobDGDuTest) {
  MsdStaticBoundaryCostV2<Mfob> cost(
      kSteps, *curb_msd_, center_line_query_helper_.get(), kSubNames, kLayers,
      circle_center_offsets_, radiuses_,
      /*using_hessian_approximate=*/false, kName);
...
TEST_F(MsdStaticBoundaryCostV2Test, MfobDDGDuDxTest) {
  MsdStaticBoundaryCostV2<Mfob> cost(
      kSteps, *curb_msd_, center_line_query_helper_.get(), kSubNames, kLayers,
      circle_center_offsets_, radiuses_,
      /*using_hessian_approximate=*/false, kName);
...
TEST_F(MsdStaticBoundaryCostV2Test, MfobDDGDuDuTest) {
  MsdStaticBoundaryCostV2<Mfob> cost(
      kSteps, *curb_msd_, center_line_query_helper_.get(), kSubNames, kLayers,
      circle_center_offsets_, radiuses_,
      /*using_hessian_approximate=*/false, kName);
