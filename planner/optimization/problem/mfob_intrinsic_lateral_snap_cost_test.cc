...
TEST(MfobIntrinsicLateralSnapCostTest, SumGTest) {
  MfobIntrinsicLateralSnapCost<Mfob> cost;
  MfobCostEvaluationTest::SumForAllStepsTest(&cost);
}

TEST(MfobIntrinsicLateralSnapCostTest, DGDxTest) {
  MfobIntrinsicLateralSnapCost<Mfob> cost;
...
TEST(MfobIntrinsicLateralSnapCostTest, DGDuTest) {
  MfobIntrinsicLateralSnapCost<Mfob> cost;
  MfobCostConvergenceTest::ExpectCostGradientResidualOrder(
      kStates, kControls,
...
TEST(MfobIntrinsicLateralSnapCostTest, DDGDxDxTest) {
  MfobIntrinsicLateralSnapCost<Mfob> cost;
...
TEST(MfobIntrinsicLateralSnapCostTest, DDGDuDxTest) {
  MfobIntrinsicLateralSnapCost<Mfob> cost;
  MfobCostConvergenceTest::ExpectCostHessianResidualOrder(
      kStates, kControls,
...
TEST(MfobIntrinsicLateralSnapCostTest, DDGDuDuTest) {
  MfobIntrinsicLateralSnapCost<Mfob> cost;
  MfobCostConvergenceTest::ExpectCostHessianResidualOrder(
      kStates, kControls,
      MfobCostConvergenceTest::GenerateControlVariationBasis(),
