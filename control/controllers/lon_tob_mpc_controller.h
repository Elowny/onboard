#ifndef ONBOARD_CONTROL_CONTROLLERS_LON_TOB_MPC_CONTROLLER_H_
#define ONBOARD_CONTROL_CONTROLLERS_LON_TOB_MPC_CONTROLLER_H_
...
// Third-order kinematic model, 3rd-order state variables: s, v, a, manipulated
// variable: jerk.
class LonTobMpcController {
 public:
  LonTobMpcController(const ControllerConf* control_conf,
 ...
 private:
  ...
  void UpdateInitialState(const VehPose& predicted_pose_after_delay,
  ...
  void UpdateMpcDebugInfo(const std::vector<Eigen::VectorXd>& state_reference,
                          const std::vector<Eigen::VectorXd>& input_reference,
                          const Eigen::VectorXd& initial_state,
                          const Eigen::MatrixXd& matrix_ad,
                          const Eigen::MatrixXd& matrix_bd,
                          const Eigen::MatrixXd& matrix_cd,
  ...
  double previous_acc_cmd_ = 0.0;
};

}  // namespace control
}  // namespace qcraft

#endif  // ONBOARD_CONTROL_CONTROLLERS_LON__TOB_MPC_CONTROLLER_H_
