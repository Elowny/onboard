...
VehicleClassification ClassifyVehicle(VehicleModel vehicle_model) {
  switch (vehicle_model) {
    ...
    case VEHICLE_SERES_SF5_SUV:
      return VehicleClassification::kPassengerCar;

    case VEHICLE_JINLV_MINIBUS:
    case VEHICLE_SKYWELL:  // not sure.
    case VEHICLE_HIGER:
    ...
    case VEHICLE_ZEV_LONGZHOU_ONE:
      return VehicleClassification::kMiniBus;
    ...
    case VEHICLE_JINLV85_LONGZHOU_LONG:
      return VehicleClassification::kShuttle;

    case VEHICLE_PIXLOOP:
    case VEHICLE_SHUNFENG:
      return VehicleClassification::kLogisticsVehicle;

    case VEHICLE_UNKNOWN:
      return VehicleClassification::kUnknown;
  }
}
